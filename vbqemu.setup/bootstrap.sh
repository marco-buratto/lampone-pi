...
function System_installDependencies()
{
	...
	apt install -y dos2unix git locales locales-all openssh-server unzip wget # base.
	apt install -y gdm3 gnome-menus gnome-session gnome-shell gnome-terminal # gnome minimal.
